<template>
    <main>
        <ul>
            <li v-for="(product, i) in comics" :key="i">
                <acomic-and-title :image="product.thumb" :title="product.series"/>    
            </li>
        </ul>
    </main>
</template>
...
<script>
import AcomicAndTitle from '../Atoms/AcomicAndTitle.vue'
export default {
  components: { AcomicAndTitle },
    data(){
        return {
            comics: [
                {
